...
export const AuthProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  useEffect(() => {
    ...
    const unsubscribe = onAuthStateChanged(auth, async (firebaseUser: FirebaseUser | null) => {
      console.log('AuthContext: onAuthStateChanged chamado, usuário:', firebaseUser ? firebaseUser.email : 'null');
      ...
      if (firebaseUser) {
        try {
          ...
          setUser(profile);
          console.log('AuthContext: Usuário setado com sucesso:', profile.email);
        } catch (error) {
          console.error('Erro ao buscar dados do usuário:', error);
          
          // Criar perfil básico mesmo com erro no Firestore
          ...
          console.log('AuthContext: Usuário básico setado:', basicProfile.email);
        }
      } else {
        console.log('AuthContext: Nenhum usuário autenticado, setando user como null');
        setUser(null);
      }
      setLoading(false);

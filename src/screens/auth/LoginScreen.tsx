      ...
      >
        <View style={{ maxWidth: 500 }}>
          ...
          <View style={{ marginBottom: 48 }}>
            ...
            <Text style={{ fontSize: 18, color: 'rgba(255,255,255,0.9)', lineHeight: 28 }}>
              Aumente sua produtividade com inteligência artificial e técnicas comprovadas de foco.
            </Text>
          </View>
          ...
          <View style={{ gap: 24 }}>
            <View style={{ flexDirection: 'row', alignItems: 'flex-start' }}>
              ...
              <View style={{ flex: 1 }}>
                ...
                <Text style={{ fontSize: 14, color: 'rgba(255,255,255,0.8)', lineHeight: 20 }}>
                  Sugestões inteligentes baseadas nos seus padrões de trabalho e produtividade
                </Text>
              </View>
            </View>
            ...
            <View style={{ flexDirection: 'row', alignItems: 'flex-start' }}>
              ...
              <View style={{ flex: 1 }}>
                ...
                <Text style={{ fontSize: 14, color: 'rgba(255,255,255,0.8)', lineHeight: 20 }}>
                  Acompanhe seu progresso com relatórios e gráficos em tempo real
                </Text>
              </View>
            </View>
          ...
          {/* Stats */}
          <View style={{ flexDirection: 'row', gap: 32, marginTop: 48, paddingTop: 32, borderTopWidth: 1, borderTopColor: 'rgba(255,255,255,0.2)' }}>
            <View>
              <Text style={{ fontSize: 32, fontWeight: 'bold', color: 'white' }}>10k+</Text>
              <Text style={{ fontSize: 14, color: 'rgba(255,255,255,0.7)' }}>Usuários ativos</Text>
            </View>
            <View>
              <Text style={{ fontSize: 32, fontWeight: 'bold', color: 'white' }}>4.9★</Text>
              <Text style={{ fontSize: 14, color: 'rgba(255,255,255,0.7)' }}>Avaliação</Text>
            </View>
            <View>
              <Text style={{ fontSize: 32, fontWeight: 'bold', color: 'white' }}>50k+</Text>
              <Text style={{ fontSize: 14, color: 'rgba(255,255,255,0.7)' }}>Sessões/mês</Text>
            </View>
          </View>
        </View>
      </LinearGradient>
      ...
      <View style={[{ flex: 1 }, getFormContainerStyle()]}>
        <SafeAreaView style={{ flex: 1 }}>
          ...
          >
            <ScrollView
              style={{ flex: 1 }}
              contentContainerStyle={{ flexGrow: 1, padding: isDesktop ? 64 : isTablet ? 48 : 24 }}
            ...
            >
              ...
              <View style={{ marginBottom: isDesktop ? 40 : 32 }}>
                <Text style={{ fontSize: isDesktop ? 32 : 24, fontWeight: 'bold', color: '#1e293b', marginBottom: 8 }}>
                  Entrar na conta
                </Text>
              ...
              <View style={{ marginBottom: 20 }}>
                ...
                <View 
                  style={{
                    ...
                    borderColor: emailFocused ? '#0ea5e9' : errors.email ? '#ef4444' : '#e2e8f0',
                  }}
                >
                  <Ionicons 
                    name="mail-outline" 
              ...
              <View style={{ marginBottom: 16 }}>
                ...
                <View 
                  style={{
                    ...
                    borderColor: passwordFocused ? '#0ea5e9' : errors.password ? '#ef4444' : '#e2e8f0',
                  }}
                >
                  <Ionicons 
              ...
              {__DEV__ && (
                ...
                >
                  <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'center' }}>
                    ...
                    <Text style={{ fontSize: 13, color: '#92400e', marginLeft: 6, fontWeight: '500' }}>
              ...
              <View style={{ flexDirection: 'row', alignItems: 'center', marginBottom: 24 }}>
                ...
                <Text style={{ paddingHorizontal: 16, fontSize: 13, color: '#94a3b8', fontWeight: '500' }}>
                  OU CONTINUE COM
                </Text>
                <View style={{ flex: 1, height: 1, backgroundColor: '#e2e8f0' }} />
              </View>
              ...
              <View style={{ flexDirection: 'row', gap: 12, marginBottom: 32 }}>
                ...
                <TouchableOpacity 
                  ...
                  onPress={() => Alert.alert('Em breve', 'Login com Apple em breve')}
                >
              ...
              {/* Trust Indicators */}
              {!isDesktop && (
                <View style={{ alignItems: 'center', paddingTop: 24, borderTopWidth: 1, borderTopColor: '#f1f5f9' }}>
                  ...
                  <View style={{ flexDirection: 'row', alignItems: 'center', gap: 16, marginTop: 8 }}>
                    <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                      <Text style={{ fontSize: 16, fontWeight: 'bold', color: '#fbbf24' }}>★★★★★</Text>
                      <Text style={{ fontSize: 13, color: '#64748b', marginLeft: 4 }}>4.9</Text>
                    </View>
                    <Text style={{ fontSize: 13, color: '#cbd5e1' }}>•</Text>
                    <Text style={{ fontSize: 13, color: '#64748b' }}>10k+ usuários</Text>
                  </View>
                </View>
              )}
            </ScrollView>

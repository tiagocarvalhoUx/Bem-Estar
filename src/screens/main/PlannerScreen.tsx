...
const PlannerScreen = () => {
  ...
  const [tasks, setTasks] = useState<Task[]>([
    {
      id: "1",
      title: "Ir ao mercado",
      description: "Comprar frutas, legumes e produtos de limpeza",
      priority: "high",
      completed: false,
    ...
    {
      id: "2",
      title: "Buscar crianças na escola",
      description: "Buscar às 17h na entrada principal",
      priority: "high",
      completed: false,
    ...
    },
    {
      id: "6",
      title: "Lavar roupas",
      description: "Separar roupas brancas e coloridas",
      priority: "low",
      completed: false,
      estimatedPomodoros: 1,
      category: "Pessoal",
  ...
  const handleSuggestTasks = () => {
    const newSuggestions = [
      {
        ...
        description: "Arrumar mesa e documentos",
      ...
      },
      {
        ...
        title: "Ler um livro",
        description: "15 páginas do livro atual",
        priority: "low" as const,
        completed: false,
        estimatedPomodoros: 1,
        aiSuggested: true,
    ...
    setTasks([...tasks, ...newSuggestions]);
    Alert.alert("Sucesso", "3 novas tarefas sugeridas foram adicionadas!");
  };
  ...
  const handleViewAnalytics = () => {
    ...
    const message =
      `📊 Estatísticas:\n\n` +
      `✅ Concluídas: ${completedCount}/${totalCount}\n` +
      `📈 Taxa de conclusão: ${completionRate}%\n` +
      `⏱️ Total de Pomodoros: ${totalPomodoros}\n` +
      `🎯 Tarefas pendentes: ${totalCount - completedCount}`;

    if (Platform.OS === 'web') {
      window.alert(message);
    } else {
      Alert.alert('Análise de Tarefas', message, [{ text: 'OK' }]);
    }
  };
    ...
    return (
      ...
      >
        ...
        >
          <LinearGradient
            colors={
              task.completed ? ["#f8fafc", "#f1f5f9"] : ["#ffffff", "#fafafa"]
            }
            style={[
              styles.taskCard,
              {
          ...
          >
            ...
            <View style={styles.taskContent}>
              ...
              <View style={styles.taskFooter}>
                {task.category && (
                  ...
                  >
                    <Text
                      style={[styles.categoryText, { color: colors.color }]}
                    >
                      {task.category}
                    </Text>
                  </View>
            ...
            <View style={styles.taskRight}>
              <View
                style={[styles.priorityBadge, { backgroundColor: colors.bg }]}
              >
  ...
  const totalPomodoros = tasks.reduce(
    (sum, t) => sum + (t.estimatedPomodoros || 0),
    0,
  );
  const completedPomodoros = completedTasks.reduce(
    (sum, t) => sum + (t.estimatedPomodoros || 0),
    0,
  );
              ...
              >
                ...
                >
                  ...
                  <Text style={styles.aiMainText}>
                    Você está 23% mais produtivo pela manhã. Considere agendar
                    suas tarefas prioritárias entre 9h e 12h.
                  </Text>
                ...
                {tasks.length === 0 && (
                  <View style={styles.emptyState}>
                    ...
                    <Text style={styles.emptyText}>
                      Adicione sua primeira tarefa para começar a organizar seu
                      dia!
                    </Text>
                    <TouchableOpacity
                      onPress={() => setShowAddModal(true)}
